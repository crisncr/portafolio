      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Línea vertical principal - oculta en móviles muy pequeños */}
            <div className="hidden sm:block absolute left-8 md:left-16 top-0 bottom-0 w-0.5 bg-gray-300 dark:bg-gray-600"></div>
            ...
            {projects.map((project, index) => {
              ...
              <motion.div
                ...
                className="relative mb-8 pl-20 md:pl-40"
              >
                {/* Cuadrado con fecha en la línea - Izquierda */}
                <div className="absolute left-0 top-0 w-16 md:w-32">
                ...
                {/* Línea vertical desde el cuadrado - oculta en móviles muy pequeños */}
                <div className="hidden sm:block absolute left-8 md:left-16 top-16 bottom-0 w-0.5 bg-gray-300 dark:bg-gray-600"></div>
